...
author: "Tasheena Narraidoo, Meron Gedrago, Wayne Violet Maumbe"
date: "2017-09-19"
output:
  html_document:
    toc: true
...
```{r, warning=FALSE}
#use cross validation to find approprate degrees of freedom
